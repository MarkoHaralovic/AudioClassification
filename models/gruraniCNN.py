...
def gruraniCNN(input_shape, N_CLASSES=11):
    model = Sequential([
        ...
        Conv2D(640, kernel_size=(3, 3), activation='elu', padding='same'),
        BatchNormalization(),
        MaxPooling2D(pool_size=(3, 3)),
        Flatten(),
...
checkpoint_filepath = 'C:\\AudioClassification\\checkpoint\\gruraniCNN.{epoch:02d}.h5'
...
model = gruraniCNN(input_shape=input_shape)
